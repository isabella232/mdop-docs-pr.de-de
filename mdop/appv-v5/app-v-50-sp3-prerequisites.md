...
Bevor Sie Microsoft Application Virtualization (App-V) 5,0 SP3 installieren, stellen Sie sicher, dass Sie alle der folgenden erforderlichen Software installiert haben.

Eine Liste der unterstützten Betriebssysteme und Hardwareanforderungen für App-v Server, Sequencer und Client finden Sie unter [unterstützte Konfigurationen für App-v 5,0 SP3](app-v-50-sp3-supported-configurations.md).
...
Installieren Sie die erforderliche erforderliche Software für die App-V 5,0 SP3-Server Komponenten.
...
<td align="left"><ul>
<li><p>Installieren des App-v-Servers auf einem Computer, auf dem eine frühere Version oder Komponente von App-v ausgeführt wird</p></li>
...
<td align="left"><p>Unterstützte Versionen finden Sie unter <a href="app-v-50-sp3-supported-configurations.md" data-raw-source="[App-V 5.0 SP3 Supported Configurations](app-v-50-sp3-supported-configurations.md)"> unterstützte Konfigurationen für App-V 5,0 SP3 </a> .</p></td>
</tr>
<tr class="even">
...
<td align="left"><p>Die Verwaltungskonsole ist nur verfügbar, wenn Silverlight installiert ist.</p></td>
</tr>
</tbody>
</table>
...
Die Verwaltungsdatenbank ist nur erforderlich, wenn Sie den App-V 5,0 SP3-Verwaltungsserver verwenden.
...
Die Berichtsdatenbank ist nur erforderlich, wenn Sie den App-V 5,0 SP3-Berichtsserver verwenden.
