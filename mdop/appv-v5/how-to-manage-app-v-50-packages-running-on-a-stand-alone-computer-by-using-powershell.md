...
---
# So verwalten Sie App-V 5.0-Pakete auf einem eigenständigen Computer mithilfe von PowerShell
...
Informationen zum Verwenden der App-V-Verwaltungskonsole zum Einrichten dieser Konfiguration finden Sie unter [Veröffentlichen eines Pakets mithilfe der Verwaltungskonsole](how-to-publish-a-package-by-using-the-management-console-50.md).
