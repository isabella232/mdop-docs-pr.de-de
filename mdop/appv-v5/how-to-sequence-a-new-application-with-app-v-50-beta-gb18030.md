...
---
# So sequenzieren Sie eine neue Anwendung mit App-V 5.0
...
4.  Überprüfen Sie die folgenden Elemente:
    ...
    -   Ab App-V 5,0 SP3 ist das primäre Virtual Application Directory (PVAD) ausgeblendet, Sie können es aber wieder aktivieren. Informationen finden Sie unter [App-V 5,0 SP3](about-app-v-50-sp3.md#bkmk-pvad-hidden).
...
6. Geben Sie auf der Seite **Package Name** einen Namen ein, der dem Paket zugeordnet werden soll. Verwenden Sie einen Namen, der hilft, den Zweck und die Version der Anwendung zu identifizieren, die dem Paket hinzugefügt werden soll. Der Paket Name wird in der App-V 5,0-Verwaltungskonsole angezeigt.
   ...
   Das **primäre virtuelle Anwendungsverzeichnis** zeigt den Pfad an, in dem die Anwendung auf den Zielcomputern installiert wird. Wenn Sie diesen Speicherort angeben möchten, wählen Sie **Durchsuchen**aus.
...
7. Geben Sie auf der Seite **Package Name** einen Namen ein, der dem Paket zugeordnet werden soll. Verwenden Sie einen Namen, der hilft, den Zweck und die Version der Anwendung zu identifizieren, die dem Paket hinzugefügt werden soll. Der Paket Name wird in der App-V 5,0-Verwaltungskonsole angezeigt. Das **primäre virtuelle Anwendungsverzeichnis** zeigt den Pfad an, in dem die Anwendung installiert wird. Wenn Sie diesen Speicherort angeben möchten, geben Sie den Pfad ein, oder klicken Sie auf **Durchsuchen**.
