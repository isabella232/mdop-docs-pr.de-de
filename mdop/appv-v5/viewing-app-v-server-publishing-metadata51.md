...
-   [App-V 5,1-Anforderungen für das Anzeigen von Veröffentlichungsmetadaten](#bkmk-51-reqs-pub-meta)
...
## <a href="" id="bkmk-51-reqs-pub-meta"></a>App-V 5,1-Anforderungen für das Anzeigen von Veröffentlichungsmetadaten


In App-v 5,1 müssen Sie die folgenden Werte in der Adresse angeben, wenn Sie den App-v-Veröffentlichungsserver nach Metadaten Abfragen:
...
<td align="left"><p>Wenn Sie den <strong> Clientversion </strong> -Parameter aus der Abfrage weglassen, schließen die Metadaten die Features aus, die in App-V 5,0 SP3 neu waren.</p></td>
</tr>
<tr class="even">
...
<tbody>
<tr class="odd">
<td align="left"><p>App-v 5,0 SP3 und App-v 5,1</p></td>
...
<div class="alert">
<strong>Hinweis:</strong><br/><p><strong>Clientversion </strong> und- <strong> Clients </strong> werden nur in App-v 5,0 SP3 und App-v 5,1 unterstützt.</p>
</div>
<div>

</div></td>
<td align="left"><p>Lesen Sie die Informationen für App-v 5,0 SP3 und App-v 5,1.</p></td>
