...
ms.locfileid: "10809580"
---
# <span data-ttu-id="105f0-103">So verwenden Sie ein PowerShell-Skript zum Erstellen des Wiederherstellungsabbilds</span><span class="sxs-lookup"><span data-stu-id="105f0-103">How to Use a PowerShell Script to Create the Recovery Image</span></span>


## <a href="" id="bkmk-create-image-use-script"></a><span data-ttu-id="105f0-104">So erstellen Sie das DART-Wiederherstellungsabbild mithilfe eines PowerShell-Skripts</span><span class="sxs-lookup"><span data-stu-id="105f0-104">To create the DaRT recovery image by using a PowerShell script</span></span>


<span data-ttu-id="105f0-105">Sie können das Microsoft Diagnostics and Recovery Toolset (Dart) 10-Wiederherstellungsabbild mithilfe eines PowerShell-Skripts erstellen, anstatt den Dart 10-Wiederherstellungsbild-Assistenten zu verwenden.</span><span class="sxs-lookup"><span data-stu-id="105f0-105">You can create the Microsoft Diagnostics and Recovery Toolset (DaRT) 10 recovery image by using a PowerShell script instead of using the DaRT 10 Recovery Image wizard.</span></span> <span data-ttu-id="105f0-106">Weitere Informationen finden Sie im folgenden Beispielskript.</span><span class="sxs-lookup"><span data-stu-id="105f0-106">See the following example script.</span></span>
...
`Import-Module "Dism"`<span data-ttu-id="105f0-107">Ich</span><span class="sxs-lookup"><span data-stu-id="105f0-107">I</span></span>`mport-Module "Microsoft.Dart"`
...
## <span data-ttu-id="105f0-108">Verwandte Themen</span><span class="sxs-lookup"><span data-stu-id="105f0-108">Related topics</span></span>


[<span data-ttu-id="105f0-109">Verwalten von DaRT 10 mithilfe von PowerShell</span><span class="sxs-lookup"><span data-stu-id="105f0-109">Administering DaRT 10 Using PowerShell</span></span>](administering-dart-10-using-powershell.md)
