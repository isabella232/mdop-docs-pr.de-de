---
title: So verwenden Sie ein PowerShell-Skript zum Erstellen des Wiederherstellungsabbilds
description: So verwenden Sie ein PowerShell-Skript zum Erstellen des Wiederherstellungsabbilds
author: dansimp
...
ms.locfileid: "10809625"
---
# <span data-ttu-id="1a823-103">So verwenden Sie ein PowerShell-Skript zum Erstellen des Wiederherstellungsabbilds</span><span class="sxs-lookup"><span data-stu-id="1a823-103">How to Use a PowerShell Script to Create the Recovery Image</span></span>


## <a href="" id="bkmk-create-image-use-script"></a><span data-ttu-id="1a823-104">So erstellen Sie das DART-Wiederherstellungsabbild mithilfe eines PowerShell-Skripts</span><span class="sxs-lookup"><span data-stu-id="1a823-104">To create the DaRT recovery image by using a PowerShell script</span></span>


<span data-ttu-id="1a823-105">Sie können das Microsoft Diagnostics and Recovery Toolset (Dart) 8,0-Wiederherstellungsabbild mithilfe eines PowerShell-Skripts erstellen, anstatt den Dart 8,0-Wiederherstellungsbild-Assistenten zu verwenden.</span><span class="sxs-lookup"><span data-stu-id="1a823-105">You can create the Microsoft Diagnostics and Recovery Toolset (DaRT) 8.0 recovery image by using a PowerShell script instead of using the DaRT 8.0 Recovery Image wizard.</span></span> <span data-ttu-id="1a823-106">Weitere Informationen finden Sie im folgenden Beispielskript.</span><span class="sxs-lookup"><span data-stu-id="1a823-106">See the following example script.</span></span>
...
`Import-Module "Dism"`<span data-ttu-id="1a823-107">Ich</span><span class="sxs-lookup"><span data-stu-id="1a823-107">I</span></span>`mport-Module "Microsoft.Dart"`
...
## <span data-ttu-id="1a823-108">Verwandte Themen</span><span class="sxs-lookup"><span data-stu-id="1a823-108">Related topics</span></span>


[<span data-ttu-id="1a823-109">Verwalten von DaRT 8.0 mithilfe von PowerShell</span><span class="sxs-lookup"><span data-stu-id="1a823-109">Administering DaRT 8.0 Using PowerShell</span></span>](administering-dart-80-using-powershell-dart-8.md)
