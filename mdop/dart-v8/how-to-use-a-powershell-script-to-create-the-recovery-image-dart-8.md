...
---
# So verwenden Sie ein PowerShell-Skript zum Erstellen des Wiederherstellungsabbilds


## <a href="" id="bkmk-create-image-use-script"></a>So erstellen Sie das DART-Wiederherstellungsabbild mithilfe eines PowerShell-Skripts


Sie können das Microsoft Diagnostics and Recovery Toolset (Dart) 8,0-Wiederherstellungsabbild mithilfe eines PowerShell-Skripts erstellen, anstatt den Dart 8,0-Wiederherstellungsbild-Assistenten zu verwenden. Weitere Informationen finden Sie im folgenden Beispielskript.
...
`Import-Module "Dism"`Ich`mport-Module "Microsoft.Dart"`
