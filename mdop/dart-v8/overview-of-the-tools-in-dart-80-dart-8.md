...
---
# Übersicht über die Tools in DaRT 8.0


Im Fenster **Diagnose-und Wiederherstellungs-Toolset** in Microsoft Diagnostics and Recovery Toolset (Dart) 8,0 können Sie alle einzelnen Tools starten, die Sie beim Erstellen des Dart 8,0-Wiederherstellungs Bilds hinzufügen. Informationen zum Zugriff auf das Toolset " **Diagnose-und Wiederherstellungstools** " finden Sie unter [Wiederherstellen von lokalen Computern mithilfe des DART-Wiederherstellungs Bilds](how-to-recover-local-computers-by-using-the-dart-recovery-image-dart-8.md).
...
Eine Beschreibung der Dart-8,0-Tools folgt.
...
Weitere Informationen zu **Crash Analyzer**finden Sie unter [Diagnostizieren von System Fehlern mit Crash Analyzer](diagnosing-system-failures-with-crash-analyzer--dart-8.md).

### Defender

**Wichtig**  In Umgebungen mit dem bereitgestellten Dart Defender sollte stattdessen das WDOLHQ-Schutz Bild (Microsoft Defender offline) für die Malware Erkennung verwendet werden. Aufgrund der Integration des Defender-Tools in DART können alle unterstützten Dart-Versions Bereitstellungen diese Antispamaktualisierungen nicht auf Ihre Dart-Bilder anwenden. Weitere Informationen finden Sie unter [Microsoft Diagnostics and Recovery Toolset (Dart) Benutzer sollten Microsoft Defender Offline (WDOLHQ) für die Malware Erkennung verwenden – >](use-windows-defender-offline-wdo-for-malware-protection-not-dart.md).

 

**Defender** kann dabei helfen, Malware und unerwünschte Software zu erkennen, und warnt Sie vor Sicherheitsrisiken. Sie können dieses Tool verwenden, um einen Computer zu überprüfen und Malware zu entfernen, selbst wenn das installierte Windows-Betriebssystem nicht ausgeführt wird. Wenn **Defender** bösartige oder unerwünschte Software erkennt, werden Sie aufgefordert, die einzelnen Elemente zu entfernen, zu isolieren oder zu erlauben.
