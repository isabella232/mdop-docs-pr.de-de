...
Wenn Sie SystemCenter2012 ConfigurationManager verwenden, müssen Sie die Datei erstellen.

In Configuration Manager 2007 ist die Datei bereits vorhanden, sodass Sie Sie nur bearbeiten müssen. Über **schreiben Sie die vorhandene Datei nicht**.
